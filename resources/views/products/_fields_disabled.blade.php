...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="inputName" name="name" value="{{ old('name', $product->name) }}" placeholder="Hamburguesa con queso" disabled>
    @if($errors->has('name'))
...
<div class="form-group">
    ...
    <textarea name="description" id="inputDescription" cols="5" rows="5" class="form-control" placeholder="Magnígica hamburguesa con extra de queso..." disabled>{{ old('description', $product->description) }}</textarea>
...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="text" class="form-control" id="inputPrice" name="price" value="{{ old('price', $product->price) }}" placeholder="10.0" disabled>
...
<div class="form-group">
    ...
    <div class="input-group">
        <input type="text" class="form-control" id="inputDiscount" name="discount" value="{{ old('discount', $product->discount) }}" placeholder="0.00" disabled>
        <div class="input-group-append">
            <span class="input-group-text">%</span>
        </div>
    </div>
...
<div class="form-group">
    ...
    @if ($categories->isNotEmpty())
        <select name="categories[]" id="selectCategories" class="form-control multi-select" multiple disabled>
...
<div class="form-group">
    ...
    @if ($ingredients->isNotEmpty())
        <select name="ingredients[]" id="selectIngredients" class="form-control select-categories multi-select" multiple disabled>
...
<div class="form-group">
    ...
    <div class="input-group">
        <div class="custom-file">
            <input type="file" accept="image/*" name="image" class="form-control-file" id="inputImage" disabled>
