...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('dependencies/fontawesome-free-5.13.0-web/css/all.min.css') }}">
    ...
    <script src="{{ asset('dependencies/fontawesome-free-5.13.0-web/js/all.min.js') }}"></script>
